    ...
    <div class="space-y-6">
        ...
        <x-filament::section>
            ...
            <x-slot name="description">
                Your active Stripe configuration and sync status
            </x-slot>
            ...
            <div class="space-y-4">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <div class="mt-1 text-lg font-semibold">
                                <span class="inline-flex items-center gap-2">
                                    ...
                                    @else
                                        <x-filament::badge color="warning">TEST</x-filament::badge>
                                    @endif
                                </span>
                            </div>
                        </div>
                    ...
                    <div class="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-800 rounded-lg">
                        <div>
                            <div class="text-sm font-medium text-gray-500 dark:text-gray-400">Publishable Key</div>
                            <div class="mt-1 text-sm font-mono">
                                {{ $this->hasStripeConfigured() ? Str::limit($this->getStripeKey(), 20) : 'Not configured' }}
                            </div>
                        </div>
                    </div>
                </div>
                ...
                @if (!$this->hasStripeConfigured())
                    ...
                    >
                        ...
                        <div class="text-sm text-gray-600 dark:text-gray-400">
                            <p>Please configure your Stripe keys in your <code>.env</code> file:</p>
                            <ul class="mt-2 list-disc list-inside space-y-1">
                                <li><code>STRIPE_ENVIRONMENT</code> - Set to 'test' or 'live'</li>
                                <li><code>STRIPE_TEST_KEY</code> & <code>STRIPE_TEST_SECRET</code> - Your test credentials</li>
                                <li><code>STRIPE_LIVE_KEY</code> & <code>STRIPE_LIVE_SECRET</code> - Your live credentials</li>
                            </ul>
                        </div>
                    </x-filament::section>
                @endif
        ...
        <x-filament::section>
            ...
            <x-slot name="description">
                Items pending synchronization with Stripe
            </x-slot>
        ...
        <x-filament::section>
            ...
            <x-slot name="description">
                How to switch between test and production Stripe accounts
            </x-slot>

            <div class="prose prose-sm dark:prose-invert max-w-none">
                <ol class="space-y-2">
                    <li>Update <code>STRIPE_ENVIRONMENT</code> in your <code>.env</code> file to either <code>test</code> or <code>live</code></li>
                    <li>Click the <strong>"Force Re-sync All"</strong> button above to sync all products to the new Stripe environment</li>
                    <li>The system will automatically detect the environment change and create/update all products in your selected Stripe account</li>
                </ol>

                <div class="mt-4 p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg border border-blue-200 dark:border-blue-800">
                    <p class="text-sm text-blue-900 dark:text-blue-100 mb-2">
                        <strong>Note:</strong> Products remember which Stripe environment they were synced to. When you switch environments,
